...
(function(){
  ...
  C("C.JR","C.JR rs1","100 0 rs1 0 10","Compressed register jump (Q2).","set_pc(RS1 & ~(reg_t)1);");
  C("C.MV","C.MV rd, rs2","100 0 rd rs2 10","Compressed register move (Q2).","WRITE_RD(RS2);");
  C("C.EBREAK","C.EBREAK","100 1 0 0 10","Compressed breakpoint (Q2).","throw trap_breakpoint();");
  C("C.JALR","C.JALR rs1","100 1 rs1 0 10","Compressed jump-and-link register (Q2).","WRITE_RD(pc + 2);\nset_pc(RS1 & ~(reg_t)1);");
